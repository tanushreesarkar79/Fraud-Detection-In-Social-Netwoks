...
[svg](https://github.com/tanushreesarkar79/Fraud-Detection-In-Social-Netwoks#project-overview)
...
[svg](https://github.com/tanushreesarkar79/Fraud-Detection-In-Social-Netwoks#features)
...
[svg](https://github.com/tanushreesarkar79/Fraud-Detection-In-Social-Netwoks#how-it-works)

Dataset Preparation: Load the dataset, clean unnecessary columns, and standardize the features. Clustering: Use the K-Means algorithm to classify users based on network activity. Cluster Analysis: Analyze cluster centers to identify suspicious behaviors and flag potentially fraudulent users. Visualization: Visualize the clustering process and the classification of users using graphs and charts.

# Technologies Used

[svg](https://github.com/tanushreesarkar79/Fraud-Detection-In-Social-Netwoks#technologies-used)

Python Pandas: For data manipulation. Scikit-learn: For K-Means clustering and data preprocessing. Seaborn/Matplotlib: For data visualization.

# How to Run the Project

[svg](https://github.com/tanushreesarkar79/Fraud-Detection-In-Social-Netwoks#how-to-run-the-project)
...
[svg](https://github.com/tanushreesarkar79/Fraud-Detection-In-Social-Netwoks#results)
